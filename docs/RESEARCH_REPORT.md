...
面经调研与排序快照：2026-08-29；答案技术核查更新至 2026-08-31。当前登记 422 个公开来源，其中 366 个面经来源、9 个维护资料、2 个岗位要求、37 个官方/规范资料和 8 个研究来源。公开 Sitemap 本轮筛查 10,302 个候选页面，按同一严格规则收敛 350 篇面经；其中 132 篇同时具备原帖链接、正文发布日期和直接问题证据，按转载/连续编号发布簇与聚合内容去重后得到 121 个独立直接样本，111 个位于最近 90 天。新增 RFC、Linux/Java/Spring/RabbitMQ/OpenTelemetry/JSON Schema/Agent Skills/WHATWG 等官方资料与原始论文只用于答案事实核查，不进入面经频次，也不移动面经排序快照。
